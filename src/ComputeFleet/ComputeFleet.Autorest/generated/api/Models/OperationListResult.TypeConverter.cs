...
namespace Sample.API.Models
{
    ...
    public partial class OperationListResultTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="OperationListResult" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Sample.API.Models.IOperationListResult ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Sample.API.Models.IOperationListResult).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
