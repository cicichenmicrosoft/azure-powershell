...
namespace Sample.API.Models
{
    ...
    public partial class VirtualMachineScaleSetListResult :
        Sample.API.Models.IVirtualMachineScaleSetListResult,
        Sample.API.Models.IVirtualMachineScaleSetListResultInternal
    {
        ...
        private System.Collections.Generic.List<Sample.API.Models.IVirtualMachineScaleSet> _value;

        /// <summary>The VirtualMachineScaleSet items on this page</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Sample.API.Models.IVirtualMachineScaleSet> Value { get => this._value; set => this._value = value; }
        ...
        Sample.API.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Sample.API.Models.IVirtualMachineScaleSet) })]
        System.Collections.Generic.List<Sample.API.Models.IVirtualMachineScaleSet> Value { get; set; }
