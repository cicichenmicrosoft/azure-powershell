...
namespace Sample.API.Models
{
    ...
    public partial class ManagedServiceIdentity
    {
        ...
        internal ManagedServiceIdentity(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_userAssignedIdentities = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("userAssignedIdentities"), out var __jsonUserAssignedIdentities) ? Sample.API.Models.UserAssignedIdentities.FromJson(__jsonUserAssignedIdentities) : _userAssignedIdentities;}
            AfterFromJson(json);
        }
