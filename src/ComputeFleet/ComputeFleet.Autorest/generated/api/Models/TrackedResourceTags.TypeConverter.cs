...
namespace Sample.API.Models
{
    ...
    public partial class TrackedResourceTagsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="TrackedResourceTags" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Sample.API.Models.ITrackedResourceTags ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Sample.API.Models.ITrackedResourceTags).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
