...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class FleetProperties
    {
        ...
        internal FleetProperties(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_spotPriorityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("spotPriorityProfile"), out var __jsonSpotPriorityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.SpotPriorityProfile.FromJson(__jsonSpotPriorityProfile) : _spotPriorityProfile;}
            {_regularPriorityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("regularPriorityProfile"), out var __jsonRegularPriorityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.RegularPriorityProfile.FromJson(__jsonRegularPriorityProfile) : _regularPriorityProfile;}
            {_additionalLocationsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("additionalLocationsProfile"), out var __jsonAdditionalLocationsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.AdditionalLocationsProfile.FromJson(__jsonAdditionalLocationsProfile) : _additionalLocationsProfile;}
            {_computeProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("computeProfile"), out var __jsonComputeProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ComputeProfile.FromJson(__jsonComputeProfile) : _computeProfile;}
            ...
            {_vMAttributes = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("vmAttributes"), out var __jsonVMAttributes) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributes.FromJson(__jsonVMAttributes) : _vMAttributes;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IFleetProperties.
        /// </summary>
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IFleetProperties.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IFleetProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._vMAttributes ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) this._vMAttributes.ToJson(null,serializationMode) : null, "vmAttributes" ,container.Add );
