...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class VMAttributes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IVMAttributes.
        /// </summary>
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IVMAttributes.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IVMAttributes FromJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode node)
        {
        ...
        internal VMAttributes(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_vCpuCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("vCpuCount"), out var __jsonVCpuCount) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxInteger.FromJson(__jsonVCpuCount) : _vCpuCount;}
            {_memoryInGiB = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("memoryInGiB"), out var __jsonMemoryInGiB) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxDouble.FromJson(__jsonMemoryInGiB) : _memoryInGiB;}
            {_memoryInGiBPerVcpu = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("memoryInGiBPerVCpu"), out var __jsonMemoryInGiBPerVcpu) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxDouble.FromJson(__jsonMemoryInGiBPerVcpu) : _memoryInGiBPerVcpu;}
            {_localStorageInGiB = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("localStorageInGiB"), out var __jsonLocalStorageInGiB) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxDouble.FromJson(__jsonLocalStorageInGiB) : _localStorageInGiB;}
            {_dataDiskCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("dataDiskCount"), out var __jsonDataDiskCount) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxInteger.FromJson(__jsonDataDiskCount) : _dataDiskCount;}
            {_networkInterfaceCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("networkInterfaceCount"), out var __jsonNetworkInterfaceCount) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxInteger.FromJson(__jsonNetworkInterfaceCount) : _networkInterfaceCount;}
            {_networkBandwidthInMbps = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("networkBandwidthInMbps"), out var __jsonNetworkBandwidthInMbps) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxDouble.FromJson(__jsonNetworkBandwidthInMbps) : _networkBandwidthInMbps;}
            {_rdmaNetworkInterfaceCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("rdmaNetworkInterfaceCount"), out var __jsonRdmaNetworkInterfaceCount) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxInteger.FromJson(__jsonRdmaNetworkInterfaceCount) : _rdmaNetworkInterfaceCount;}
            {_acceleratorCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("acceleratorCount"), out var __jsonAcceleratorCount) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VMAttributeMinMaxInteger.FromJson(__jsonAcceleratorCount) : _acceleratorCount;}
