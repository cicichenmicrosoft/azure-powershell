...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class BaseVirtualMachineProfile
    {
        ...
        internal BaseVirtualMachineProfile(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VirtualMachineScaleSetNetworkProfile.FromJson(__jsonNetworkProfile) : _networkProfile;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.SecurityProfile.FromJson(__jsonSecurityProfile) : _securityProfile;}
            {_diagnosticsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("diagnosticsProfile"), out var __jsonDiagnosticsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.DiagnosticsProfile.FromJson(__jsonDiagnosticsProfile) : _diagnosticsProfile;}
            {_extensionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("extensionProfile"), out var __jsonExtensionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VirtualMachineScaleSetExtensionProfile.FromJson(__jsonExtensionProfile) : _extensionProfile;}
            {_scheduledEventsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("scheduledEventsProfile"), out var __jsonScheduledEventsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ScheduledEventsProfile.FromJson(__jsonScheduledEventsProfile) : _scheduledEventsProfile;}
            {_capacityReservation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("capacityReservation"), out var __jsonCapacityReservation) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.CapacityReservationProfile.FromJson(__jsonCapacityReservation) : _capacityReservation;}
            {_applicationProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("applicationProfile"), out var __jsonApplicationProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ApplicationProfile.FromJson(__jsonApplicationProfile) : _applicationProfile;}
            {_hardwareProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("hardwareProfile"), out var __jsonHardwareProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VirtualMachineScaleSetHardwareProfile.FromJson(__jsonHardwareProfile) : _hardwareProfile;}
            {_serviceArtifactReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("serviceArtifactReference"), out var __jsonServiceArtifactReference) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ServiceArtifactReference.FromJson(__jsonServiceArtifactReference) : _serviceArtifactReference;}
            {_securityPostureReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("securityPostureReference"), out var __jsonSecurityPostureReference) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.SecurityPostureReference.FromJson(__jsonSecurityPostureReference) : _securityPostureReference;}
            ...
            {_oSProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("osProfile"), out var __jsonOSProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VirtualMachineScaleSetOSProfile.FromJson(__jsonOSProfile) : _oSProfile;}
            {_storageProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("storageProfile"), out var __jsonStorageProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.VirtualMachineScaleSetStorageProfile.FromJson(__jsonStorageProfile) : _storageProfile;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IBaseVirtualMachineProfile.
        /// </summary>
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IBaseVirtualMachineProfile.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.IBaseVirtualMachineProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode node)
        {
