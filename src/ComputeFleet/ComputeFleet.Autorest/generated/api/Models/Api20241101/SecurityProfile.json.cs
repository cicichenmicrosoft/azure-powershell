...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101
{
    ...
    public partial class SecurityProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ISecurityProfile.
        /// </summary>
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ISecurityProfile.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ISecurityProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode node)
        {
        ...
        internal SecurityProfile(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_uefiSettings = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("uefiSettings"), out var __jsonUefiSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.UefiSettings.FromJson(__jsonUefiSettings) : _uefiSettings;}
            {_encryptionIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("encryptionIdentity"), out var __jsonEncryptionIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.EncryptionIdentity.FromJson(__jsonEncryptionIdentity) : _encryptionIdentity;}
            {_proxyAgentSettings = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject>("proxyAgentSettings"), out var __jsonProxyAgentSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Models.Api20241101.ProxyAgentSettings.FromJson(__jsonProxyAgentSettings) : _proxyAgentSettings;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._uefiSettings ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) this._uefiSettings.ToJson(null,serializationMode) : null, "uefiSettings" ,container.Add );
            ...
            AddIf( null != this._proxyAgentSettings ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeFleet.Runtime.Json.JsonNode) this._proxyAgentSettings.ToJson(null,serializationMode) : null, "proxyAgentSettings" ,container.Add );
