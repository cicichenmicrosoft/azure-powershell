...
namespace Sample.API.Models
{
    ...
    public partial class ManagedServiceIdentityTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ManagedServiceIdentity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Sample.API.Models.IManagedServiceIdentity ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Sample.API.Models.IManagedServiceIdentity).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
