...
namespace Sample.API.Models
{
        ...
        Sample.API.Models.IOperationDisplayInternal
    {
        ...
        string Sample.API.Models.IOperationDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Sample.API.Models.IOperationDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Sample.API.Models.IOperationDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Sample.API.Models.IOperationDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
