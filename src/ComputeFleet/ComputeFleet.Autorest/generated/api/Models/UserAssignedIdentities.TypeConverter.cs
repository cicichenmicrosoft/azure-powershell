...
namespace Sample.API.Models
{
    ...
    public partial class UserAssignedIdentitiesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="UserAssignedIdentities" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Sample.API.Models.IUserAssignedIdentities ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Sample.API.Models.IUserAssignedIdentities).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
