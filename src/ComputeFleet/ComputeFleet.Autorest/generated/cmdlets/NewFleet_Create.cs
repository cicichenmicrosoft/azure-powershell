...
namespace Sample.API.Cmdlets
{
        ...
        Sample.API.Runtime.IContext
    {
        ...
        public Sample.API.Cmdlets.NewFleet_Create Clone()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FleetsCreateOrUpdate(SubscriptionId, ResourceGroupName, FleetName, Resource, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
