...
namespace Sample.API.Cmdlets
{
        ...
        Sample.API.Runtime.IContext
    {
        ...
        public Sample.API.Cmdlets.UpdateFleet_Update Clone()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FleetsUpdate(SubscriptionId, ResourceGroupName, FleetName, Properties, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeUpdate);
