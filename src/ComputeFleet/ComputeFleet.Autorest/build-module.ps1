...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\ComputeFleet.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './ComputeFleet.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './ComputeFleet.format.ps1xml'
