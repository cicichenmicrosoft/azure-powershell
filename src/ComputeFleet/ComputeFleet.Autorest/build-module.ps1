...
$dll = Join-Path $PSScriptRoot 'bin\Fleet.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Fleet.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Fleet.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './Fleet.format.ps1xml'
