...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ComputeFleet.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ComputeFleet.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ComputeFleet.format.ps1xml'
