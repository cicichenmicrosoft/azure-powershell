...
INPUTOBJECT <IFleetIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/fleet/remove-fleet
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Fleet.private\Remove-Fleet_Delete';
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'Fleet.private\Set-Fleet_Update';
            UpdateExpanded = 'Fleet.private\Set-Fleet_UpdateExpanded';
            UpdateViaIdentity = 'Fleet.private\Set-Fleet_UpdateViaIdentity';
